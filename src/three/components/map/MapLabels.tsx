  ...
  return (
    <Html position={[-3.6, 2.7, 0]} distanceFactor={14} style={{ pointerEvents: 'none' }}>
      <div className="flex items-center gap-2 select-none">
        <div className="px-3 py-1 rounded-full bg-slate-900/90 dark:bg-slate-950/90 border border-blue-500/30 backdrop-blur-md shadow-lg flex items-center gap-2">
